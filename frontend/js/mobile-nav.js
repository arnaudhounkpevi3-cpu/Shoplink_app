...
const MobileNav = {
  ...
  injectMobileMenu() {
    ...
    if (isPublic) {
      links = `
        <a href="/homepage-shoplink.html" class="mobile-nav-item" onclick="MobileNav.closeMenu()"><span data-i18n="nav.home">Accueil</span></a>
        <a href="/index.html" class="mobile-nav-item" onclick="MobileNav.closeMenu()"><span data-i18n="nav.portal">Portail ShopLink</span></a>
        <div class="mobile-nav-divider"></div>
        <a href="/login.html" class="mobile-nav-item" onclick="MobileNav.closeMenu()"><span data-i18n="nav.login">Connexion</span></a>
        <a href="/register.html" class="mobile-nav-item active" onclick="MobileNav.closeMenu()"><span data-i18n="nav.create">Créer mon site</span></a>
      `;
    } else if (isDashboard) {
      links = `
        ...
        <button class="mobile-nav-item" onclick="nav('parametres',null);MobileNav.closeMenu()"><span data-i18n="nav.settings">Paramètres</span></button>
        <div class="mobile-nav-divider"></div>
...
function switchBottomNav(id, btn) {
  // Appeler la fonction nav() du dashboard si elle existe
