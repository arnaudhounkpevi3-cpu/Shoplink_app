          ...
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;max-width:600px;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 18px 60px rgba(17,17,17,0.10);border:1px solid rgba(17,17,17,0.08);">
            <tr>
              <td style="background:linear-gradient(135deg,#1a5c38,#0f6e56);padding:38px 28px;text-align:center;">
                ...
                <p style="color:rgba(255,255,255,0.78);margin:10px 0 0;font-size:15px;line-height:1.5;">Ton paiement est validé. Ta boutique est prête.</p>
              </td>
            </tr>
            <tr>
              <td style="padding:34px 30px;">
                <p style="font-size:16px;color:#1a1a1a;line-height:1.65;margin:0 0 16px;">Bonjour <strong>${firstName}</strong>,</p>
                <p style="font-size:16px;color:#333333;line-height:1.65;margin:0 0 16px;">Ton paiement ShopLink a été confirmé avec succès. Tu peux maintenant accéder à ton tableau de bord, gérer ta boutique, ajouter tes produits et partager ton lien public.</p>
                <p style="font-size:15px;color:#5f6f67;line-height:1.65;margin:0 0 24px;">Depuis ton dashboard, tu peux suivre les vues, gérer ton catalogue et recevoir les commandes de tes clients.</p>
                ...
                <div style="background:#eef7f1;border:1px solid rgba(26,92,56,0.12);border-radius:14px;padding:16px 18px;margin-top:22px;">
                  <p style="margin:0;color:#0f6e56;font-size:14px;line-height:1.55;"><strong>Prochaine étape :</strong> vérifie l’aperçu de ton site public, ajoute tes premiers produits et partage ton lien ShopLink.</p>
                </div>
              </td>
            </tr>
            <tr>
