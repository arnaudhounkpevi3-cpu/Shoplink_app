...
create index if not exists transactions_statut_idx on public.transactions(statut);
...
create index if not exists sms_logs_reference_idx on public.sms_logs(reference);
